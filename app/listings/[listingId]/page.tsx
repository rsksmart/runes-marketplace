...
const ListingPage = () => {
    const contractAddress = "0x268fdeF588d5e4492774578e076c32Dfe5FdFFD8"
    const { contract } = useContract(contractAddress, "marketplace-v3")

    const { listingId } = useParams() as unknown as { listingId: number };
    const { data: listing, isLoading: loadingListing } = useDirectListing(contract, listingId);
                    ...
                    <Card>
                                    ...
                                    >
                                        <div className="justify-center flex w-full">
                                            {listing!.asset.image ? (
                                                ...
                                                <MediaRenderer className='rounded-lg mb-2' width="200px" height='200px' src={listing!.asset.image} />
                                            ) : (
                                                <div className="w-[200px] h-[200px] my-2 bg-gray-200 rounded-lg dark:bg-gray-700 items-center justify-center flex">
                                                    <Image className="w-14 h-14 text-white dark:text-gray-100"></Image>
                                                </div>
                                        ...
                                        <div className="">
                                            ...
                                            <div className="flex flex-row items-center gap-4">
                                                ...
                                                <div className="flex flex-row items-center gap-2 text-gray-400 hover:text-white cursor-pointer">
                                                    <span>
                                                        {styleAddress(listing!.creatorAddress)}
                                                    </span>
                                                    <Copy className="w-4"></Copy>
                                                </div>
                                            </div>
                                            <div className="flex flex-row items-center gap-4">
                                                <Label className="text-bold text-1xl w-32">Rune Address</Label>
                                                <div className="flex flex-row items-center gap-2 text-gray-400 hover:text-white cursor-pointer">
                                                    <span>
                                            ...
                                            <div className="flex flex-row items-center gap-4">
                                                <Label className="text-bold text-1xl w-32">Buyout Price</Label>
                                                <div>
                        ...
                        <CardFooter className="px-0 relative justify-end mb-6 mr-4">
                            {!buyingInProgress ? (<Web3Button
                                ...
                                onSubmit={() => { setBuyingInProgress(true) }}
